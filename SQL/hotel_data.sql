...
MySQL - 8.0.22 : Database - dbexperiment
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`dbexperiment` /*!40100 DEFAULT CHARACTER SET utf32 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `customer` (
  ...
  `uName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户姓名',
  PRIMARY KEY (`uID`) USING BTREE,
  KEY `uID` (`uID`) USING BTREE,
  KEY `uID_2` (`uID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2019019 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `order` (
  `order_id` int NOT NULL AUTO_INCREMENT COMMENT '自动递增的主键',
  ...
  KEY `room_order_id` (`room_id`) USING BTREE,
  KEY `customer_id` (`customer_id`) USING BTREE,
  KEY `orderpayment` (`payment` DESC),
...
insert  into `order`(`order_id`,`room_id`,`start_date`,`leave_date`,`amount`,`payment`,`create_date`,`customer_id`) values 
...
CREATE TABLE `rating` (
  `rID` int NOT NULL AUTO_INCREMENT COMMENT '评分表主键',
  `stars` int NOT NULL COMMENT '0-5分',
  `order_id` int NOT NULL COMMENT '订单编号',
  `uID` int DEFAULT NULL COMMENT '顾客ID',
  `rate_date` datetime DEFAULT NULL,
  PRIMARY KEY (`rID`) USING BTREE,
  KEY `uID` (`uID`) USING BTREE,
  KEY `room_id` (`order_id`),
  CONSTRAINT `rating_ibfk_2` FOREIGN KEY (`uID`) REFERENCES `customer` (`uID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `rating_ibfk_3` FOREIGN KEY (`order_id`) REFERENCES `order` (`order_id`)
...
CREATE TABLE `room_info` (
  ...
  KEY `room_info_key` (`room_id`) USING BTREE,
...
CREATE TABLE `room_type` (
  ...
  KEY `hotel_room_key` (`hotel_id`) USING BTREE,
